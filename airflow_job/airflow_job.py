...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflow-projetcs-gds-test-new")
    bq_project = Variable.get("bq_project", default_var="modular-seeker-446407-f7")
    ...
    pyspark_task = DataprocCreateBatchOperator(
        ...
        batch=batch_details,
        batch_id=batch_id,
        project_id="modular-seeker-446407-f7",
        region="us-central1",
